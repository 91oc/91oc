		...
		<div class="box box-primary">
			...
			<div class="box-body">
				...
				<div class="sap-box-inner sap-api-twitter-autopost">
					<div class="form-group">
						<label for="tw-post-users" class="col-sm-4 control-label"><?php echo $sap_common->lang('autopost_to_twi_users'); ?></label>
					...
					<div class="form-group">
						<label for="" class="col-sm-4 control-label"> <?php echo $sap_common->lang('twi_post_img'); ?></label>
