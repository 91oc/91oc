            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="tg-list-item col-sm-9">
                        ...
                        <span class="sap-desc"><?php echo $sap_common->lang('post_content_help_text'); ?></span>
                    </div>
                </div>
            </div>
                        ...
                        foreach ($sap_tumblr_keys as $key => $value) {
                            ...
                            <div class="form-group sap-tumblr-account-details" data-row-id="<?php echo $key; ?>">
                                ...
                                <?php } else if (!empty($value['tumblr_consumer_key']) && !empty($value['tumblr_consumer_secret'])) {
                                    ?>
                                    <div class="col-sm-2 tumblr-grant-permission">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="sap-box-inner sap-api-tumblr-settings">
                    ...
                    <div class="form-group">
                        <label for="tumblr-select-accounts" class="col-sm-4 control-label"><?php echo $sap_common->lang('autopost_to_tumb_users'); ?>)</label>
                    ...
                    <div class="form-group">
                        <label for="tumblr-post-users" class="col-sm-4 control-label"><?php echo $sap_common->lang('posting_type'); ?></label>
                        <div class="tg-list-item col-sm-6">
                            <?php
                    ...
                    <div class="form-group sap-tumblr-post-link">
                        <label for="sap_tumblr_link" class="col-sm-4 control-label"><?php echo $sap_common->lang('link'); ?></label>
                        <div class="tg-list-item col-sm-6">
                    ...
                    <div class="form-group sap-tumblr-post-image">
                        <label for="" class="col-sm-4 control-label"> <?php echo $sap_common->lang('tumb_post_img'); ?></label>
