    ...
    <form id="instagram-settings" class="form-horizontal" method="POST" action="<?php echo SAP_SITE_URL . '/settings/save/'; ?>" enctype="multipart/form-data"> 
        ...
        <div class="box box-primary">
            ...
            <div id="facebook-app-method">
                ...
                echo '<p><a class="sap-grant-fb-android btn btn-primary" href="' . $instagram->sap_auto_poster_get_fb_app_method_login_url() . '"> '.$sap_common->lang("facebook_add_account").' </a></p>';
                if (!empty($inta_fb_app_accounts)) {
                    echo '</div>';
                }
                if ( !empty($inta_fb_app_accounts) ) {
