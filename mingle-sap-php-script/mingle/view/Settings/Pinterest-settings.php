    ...
    <form id="pinterest-settings" class="form-horizontal" method="POST" action="<?php echo SAP_SITE_URL . '/settings/save/'; ?>" enctype="multipart/form-data"> 
                        ...
                        <div class="form-group control-pinterest-wrap">
                            ...
                            <div class="col-sm-6 col-lg-3 pull-left">
                                <div class="add-pin-account-pint">                            
                                    <button type="button" class="btn btn-primary add-pin-account"><?php echo $sap_common->lang('pit_add_account'); ?></button>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="sap-box-inner sap-api-pinterest-settings">
                    <div class="form-group">
                        <label for="app-setting" class="col-sm-4 control-label"><?php echo $sap_common->lang('autopost_to_pit_users'); ?></label>
                    ...
                    <div class="form-group">
                        <label for="app-setting" class="col-sm-4 control-label"><?php echo $sap_common->lang('pit_post_img'); ?></label>
