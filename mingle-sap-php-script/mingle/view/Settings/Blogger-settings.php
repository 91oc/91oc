...
<div class="tab-pane <?php echo ( $active_tab == "blogger") ? "active" : '' ?>" id="blogger">
	<form id="blogger-settings" class="form-horizontal" method="POST" action="<?php echo SAP_SITE_URL . '/settings/save/'; ?>" enctype="multipart/form-data"> 
        ...
        <div class="box box-primary d-flex flex-wrap">
            <div class="box-header sap-settings-box-header col-md-4"><?php echo $sap_common->lang('blogger_api_setting'); ?></div>

            <div id="facebook-app-method" class="col-md-12 fb-method">
                <?php
                ...
                if ( empty( $blogger_app_accounts ) ) {
                    echo '<a class="sap-grant-fb-android btn btn-primary" href="'. $blogger->sap_auto_poster_get_blogger_login_url() .'"> '.$sap_common->lang("blogger_add_account").' </a>';
                }
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="sap-box-inner sap-api-blogger-autopost">
                    ...
                    <div class="form-group">
                        <label for="tw-post-users" class="col-sm-4 control-label"><?php echo $sap_common->lang('autopost_to_blogger_users'); ?><span class="astric">*</span></label>
                    ...
                    <div class="form-group">
                        <label for="" class="col-sm-4 control-label"> <?php echo $sap_common->lang('blogger_post_img'); ?></label>
