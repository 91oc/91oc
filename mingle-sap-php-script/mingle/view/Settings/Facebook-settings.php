...
<div class="tab-pane <?php echo ( $active_tab == "facebook") ? "active" : "" ?>" id="facebook">
    <form id="facebook-settings" class="form-horizontal" method="POST" action="<?php echo SAP_SITE_URL . '/settings/save/'; ?>" enctype="multipart/form-data"> 
        ...
        ?>
        <div class="box box-primary box-inner-div">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="sap-box-inner sap-api-facebook-settings">
                    ...
                    <div id="facebook-app-method" style="<?php print $app_style; ?>">
                        <?php
                        if (!empty($fb_app_accounts)) {
                            echo '<div class="fb-btn">';
                        }
                        echo '<p><a class="sap-grant-fb-android btn btn-primary" href="' . $facebook->sap_auto_poster_get_fb_app_method_login_url() . '"> '.$sap_common->lang("facebook_add_account").' </a></p>';
                        if (!empty($fb_app_accounts)) {
                            echo '</div>';
                        }
            ...
            <div class="box-body">
                <div class="sap-box-inner">
                    <div class="form-group">
                        ...
                        <label for="app-setting" class="col-sm-4 control-label"><?php echo $sap_common->lang('autopost_to_fb_users'); ?></label>
                    ...
                    <div class="form-group"> 
                        ...
                        <label for="app-setting" class="col-sm-4 control-label"><?php echo $sap_common->lang('share_posting_type'); ?></label>
                    ...
                    <div class="form-group show-fb-image-post">
                        <label for="" class="col-sm-4 control-label"><?php echo $sap_common->lang('facebook_post_img'); ?></label>
                    ...
                    <div class="form-group">   
                        <label for="app-setting" class="col-sm-4 control-label"><?php echo $sap_common->lang('url_shortener'); ?></label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label for="" class="col-sm-4 control-label"><?php echo $sap_common->lang('bit_access_token'); ?></label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label for="" class="col-sm-4 control-label"><?php echo $sap_common->lang('shorte_api_token'); ?></label>
                        <div class="col-sm-6">
