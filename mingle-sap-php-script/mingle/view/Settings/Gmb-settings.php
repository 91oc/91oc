...
<div class="tab-pane <?php echo ( $active_tab == "gmb") ? "active" : "" ?>" id="gmb">
    <form id="google-business-settings" class="form-horizontal" method="POST" action="<?php echo SAP_SITE_URL . '/settings/save/'; ?>" enctype="multipart/form-data"> 
        ...
        <div class="box box-primary">
            <div class="box-header sap-settings-box-header"><?php echo $sap_common->lang('gmb_api_setting'); ?> </div>
            <div class="box-body">
                <div class="sap-box-inner sap-api-facebook-settings sap-api-google-business-settings">
                    <div id="facebook-app-method">
                        ...
                        echo '<p><a class="sap-grant-fb-android btn btn-primary" href="' . $google_business->sap_get_gmb_app_method_login_url() . '">'.$sap_common->lang('add_gmb_account').'</a></p>';
            ...
            <div class="box-body">
                <div class="sap-box-inner sap-api-google-business-settings">
                    ...
                    <div class="form-group">
                        ...
                        <label for="app-setting" class="col-sm-4 control-label"><?php echo $sap_common->lang('autopost_to_gmb_users'); ?></label>
                    ...
                    <div class="form-group"> 
                        ...
                        <label for="app-setting" class="col-sm-4 control-label"><?php echo $sap_common->lang('gmb_btn_type'); ?></label>
                    ...
                    <div class='form-group'>                  
                        ...
                        <label for="app-setting" class="col-sm-4 control-label"><?php echo $sap_common->lang('gmb_post_img'); ?></label>
