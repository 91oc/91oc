								...
								<div class="box-primary">
									...
									<div class="row">
										<div class="col-md-12 form-group ">
											<div class="col-md-8 form-group logo-img-edit">
												<div class="row">
													<label for="mingle_logo" class="col-sm-4 col-md-3 control-label"><?php echo $sap_common->lang('upload_logo'); ?></label>
										...
										<div class="col-md-12 form-group ">
											<div class="col-md-8 form-group favicon-img-edit">
												<div class="row">
													<label for="mingle_favicon" class="col-sm-4 col-md-3 control-label"><?php echo $sap_common->lang('upload_favicon'); ?></label>
										...
										<div class="col-md-12 form-group">
											<div class="col-md-8 form-group">
												<div class="row">
													<label for="mingle_site_name" class="col-sm-4 col-md-3 control-label"><?php echo $sap_common->lang('site_name'); ?></label>
													<div class="col-sm-8 col-md-9">
										...
										<div class="col-md-12 form-group">
											<div class="col-md-8 form-group">
												<div class="row">
													<label for="mingle_meta_title" class="col-sm-4 col-md-3 control-label"><?php echo $sap_common->lang('meta_title'); ?></label>
													<div class="col-sm-8 col-md-9">
										...
										<div class="col-md-12 form-group">
											<div class="col-md-8 form-group">
												<div class="row">
													<label for="mingle_meta_description" class="col-sm-4 col-md-3 control-label"><?php echo $sap_common->lang('meta_description'); ?></label>
													<div class="col-sm-8 col-md-9">
									...
									<div class="box-header"></div>
									<div class="box-header sap-settings-box-header"><?php echo $sap_common->lang('footer_setting_label'); ?></div>
									<div class="row">
										<div class="col-md-12 form-group ">
											<div class="col-md-8 form-group">
												<div class="row">
													<label for="footer_content" class="col-sm-4 col-md-3 control-label"><?php echo $sap_common->lang('content'); ?></label>
													<div class="col-sm-8 col-md-9">
									...
									<div class="box-header"></div>
									<div class="box-header sap-settings-box-header"><?php echo $sap_common->lang('api_key_setting_heading'); ?></div>
									<div class="row">
										<div class="col-md-12 form-group">
											<div class="col-md-8 form-group">
												<div class="row">
													<label for="sap_chatgpt_api_key" class="col-sm-4 col-md-3 control-label"><?php echo $sap_common->lang('enter_api_key'); ?></label>
													<div class="col-sm-8 col-md-9">
											...
											<div class="tab-pane" id="stripe">
												<div class="row sap_plan">
													...
													<div class="col-md-12 form-group">
														<div class="col-md-6 form-group">
															<div class="row">
																<label class="col-sm-4 col-md-3 control-label"><?php echo $sap_common->lang('billing_detail_settings'); ?> </label>
																<div class="col-sm-8 col-md-9">
