        ...
        <div class="form-group">
            ...
            <div class="col-sm-8 col-xs-7">
                ...
                if (isset($status) && array_key_exists($status, $sap_instagram_post_status)) {
                   echo '<label class="_sap_instagram_status_lbl">'.$sap_instagram_post_status[$status].'</label>&nbsp;&nbsp;';
                ...
                echo '<label class="_sap_instagram_status_lbl">'.$sap_common->lang('unpublished').'</label>&nbsp;&nbsp;';
            }
            ?>
        </div>
        </div>
