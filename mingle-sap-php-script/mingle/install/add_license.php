                    ...
                    <form action="add_license.php" method="post">
                        ...
                        <table width="100%" border="0" cellspacing="1" cellpadding="1">			
                            ...
                            <tr>
                                ...
                                <td><input name="sap_license_email" id="sap_license_email" class="form_text" size="28" maxlength="125" value="<?php echo $sap_license_email; ?>" placeholder="<?php echo $sap_common->lang('sap_license_email'); ?>" /></td>
                            ...
                            <tr>
                                ...
                                <td><input name="sap_license_key" id="sap_license_key" class="form_text" type="text" size="28" maxlength="40" value="<?php echo $sap_license_key; ?>" onfocus="textboxOnFocus('notes_license_key')" onblur="textboxOnBlur('notes_license_key')" placeholder="<?php echo $sap_common->lang('sap_license_key_placeholder'); ?>" /></td>
                            </tr>
